...
/***/ "./asset/data/placeholder.data.png":
/*!*****************************************!*\
  !*** ./asset/data/placeholder.data.png ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports=(__webpack_require__(/*! alt1/base */ "../node_modules/alt1/dist/base/index.js").ImageDetect).imageDataFromBase64("iVBORw0KGgoAAAANSUhEUgAAACAAAAAgAQMAAABJtOi3AAAAAW5vUEUAYtdMlAAAAAlub1BFAAAAAAAAAAAAoYpy1QAAAANQTFRFAAAAp3o92gAAAA9JREFUeJxjZAACxsFLAAAK8AAhCVrP+AAAAABJRU5ErkJggg==")
...
async function startApp() {
    ...
    abilityHighlight.placeholder = await resizeImageData(abilityHighlight.placeholder, parseInt((0,_A1Sauce_Settings_Storage__WEBPACK_IMPORTED_MODULE_6__.getSetting)('scaleFactor'), 10) / 100);
    for (let i = 0; i < 8; i++) {
    ...
    if (window.alt1) {
        ...
        appScaleEl.style.background =
            'linear-gradient(to right, #3e5765 0%, #3e5765 ' +
                ...
                appScaleVal +
                '%, #0d1c24 100%)';
        const overlayScale = (0,_A1Sauce_Utils_getById__WEBPACK_IMPORTED_MODULE_10__.getById)('scaleFactor');
        const overlayScaleVal = ((parseInt(overlayScale.value, 10) - parseInt(overlayScale.min, 10)) /
